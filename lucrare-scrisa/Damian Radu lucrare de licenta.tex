...
\subsubsection{Scopul aplicației}
Scopul acestei aplicații este de a oferi o soluție în a contracara cantitatea masivă de informații ce se regăsește pe internet \cite{1} în ceea ce privește multitudinea de jocuri video, prin a dezvolta un sistem de recomandări care să faciliteze decizia unui utilizator legat de ce joc să aleagă.  
...
Un nod în neo4j are următoarele caracteristici \cite{2}: reprezintă entități/obiecte, pot fi etichetate și pot avea proprietăți.
...
!!De comparat o interogare(de exemplu: prietenii prietenului unui utilizator) în limbajele SQL și Cypher.
