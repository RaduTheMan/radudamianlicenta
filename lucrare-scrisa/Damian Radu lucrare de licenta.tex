...
Toate fișierele ce sunt necesare pentru instalarea locală a aplicației se găsesc în următorul \emph{link} de pe Github: 

\url{https://github.com/RaduTheMan/radudamianlicenta}

\newpage

\bigskip
\textbf{Instalarea și setarea bazei de date}
\bigskip
